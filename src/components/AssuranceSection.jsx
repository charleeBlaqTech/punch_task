...
function AssuranceSection() {
  ...
  return (
    <section className="w-full 2xl:w-[1440px] bg-[#FFFFFF] pt-8 md:pt-[93.5px] 2xl:border-4">
        ...
        <div className="main-contents-wrapper w-full lg:h-[993px] bg-[#FFFFFF] px-6 lg:px-[70px] grid grid-cols-1 lg:grid-cols-2 z-50 -mt-[45px] lg:-mt-[16px]">

            <div className="assurance-left-wrap w-full pt-8 lg:pt-[149px]">
                <div className="assurance-left-side-title-wrap w-full lg:w-[570px] h-[128px] text-[#202229]">
                    <h3 className='h-full text-center md:text-left align-top text-4xl md:leading-[64px] md:text-[54px]'>How we ensure you're in good hands.</h3>
                </div>
                ...
                <div className="assurance-left-side-dropdown-wrap mt-8 sm:mt-0">
                    ...
                    <div className="items-wrap border-2 border-[#F0F0F0] w-full lg:w-[635px] h-[80px] bg-[#F4F4F4] rounded-[7px] pl-[20px] py-[11px] mb-[4px] flex items-center gap-[23px] z-30 mt-[2px]">
                    ...
                    <div className="items-wrap border-2 border-[#F0F0F0] w-full lg:w-[635px] h-[163px] bg-[#FFFFFF] rounded-[7px] pl-[20px] py-[11px] mb-[4px]">
                        ...
                        <div className='w-full md:w-[531px] h-[52px] mt-[24px] text-[#202229]'>
            ...
            <div className="assurance-right-wrap pt-8 lg:pt-[337px] lg:pl-[85px] 2xl:pl-[166px]">
                <div className="contents-wrap w-full lg:w-[514px] h-[524.5px] bg-[#FFFFFF] flex items-start border-2">
                    <div className='mt-[201.5px] flex items-center gap-[12px]'>
                        ...
                        <div className=' text-[#202229] flex flex-col items-center justify-center gap-[33px]'>
                    ...
                    <div className='w-[234px] h-[234px]'>
                        <img src={girlImg} alt="" width={'100%'} height={'100%'} />
                    </div>
                </div>
            </div>
        </div>
