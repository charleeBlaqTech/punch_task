...
function JourneySection() {
  return (
    <section className="w-full h-auto 2xl:w-[1440px] pl-[16px] 2xl:pl-[70px] 2xl:pt-[151px]">

        <div className='w-full 2xl:w-[1440px] pl-[16px] 2xl:pl-[332px]'>
            <div className='w-full 2xl:w-[637px] h-[64px] text-[#202229]'>
                <h4 className='w-auto font-bold text-center align-top leading-[40px] text-[28px] sm:leading-[50px] sm:text-[44px] 2xl:leading-[64px] 2xl:text-[54px]'>
