...
function FaqSection() {
  return (
    <section className=" faq-styles flex flex-col items-center w-full 2xl:w-[1440px] bg-[##E8E8E8] z-10 -mb-2">
      ...
      <div className="w-full 2xl-w-[1440px] mt-[44px] xl:mt-[88px] grid grid-cols-1 grid-rows-8">
        ...
        <div className="h-[112px] border-2 flex flex-col gap-4 md:flex-row xl:gap-[410px]">
            ...
            <div className='flex items-center '>
              <p className='w-[434px] h-[24px] break-words text-start align-top leading-[24px] text-[22px]'>I want to work part-time, is that possible.</p>
            </div>
        </div>
        <div className="h-[112px] border-2 flex flex-col md:flex-row xl:gap-[410px]">
            ...
            <div className='flex items-center '>
            <p className='w-[369px] h-[24px] break-words text-start align-top leading-[24px] text-[22px]'>How much are the average projects?</p>
            </div>
        </div>
        <div className="h-[112px] border-2 flex flex-col md:flex-row xl:gap-[410px] bg-[#D6D6D6]">
            ...
            <div className='flex items-center '>
            <p className='w-[317px] h-[24px] break-words text-start align-top leading-[24px] text-[22px]'>How does the payment work?.</p>
            </div>
        </div>
        <div className="h-[112px] border-2 flex flex-col md:flex-row xl:gap-[410px] ">
            <div className='w-[230px] pl-[70px]'>
            ...
            <div className='flex items-center '>
            <p className='w-[231px] h-[24px] break-words text-start align-top leading-[24px] text-[22px]'>How much can i earn?.</p>
            </div>
        </div>
        <div className="h-[112px] border-2 flex flex-col gap-4 md:flex-row xl:gap-[111px]">
      ...
      <div className="w-full 2xl-w-[1440px] h-[64.5px] 2xl:mt-[108px] ">
